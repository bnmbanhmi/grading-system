...
def refine_comment_tone(client: genai.Client, original_comment: str, component_name: str, score: float, course_level: str = "undergraduate"):
    """
...
def refine_all_assessment_comments(client: genai.Client, assessment_data: dict, course_level: str = "undergraduate"):
    """
...
def refine_comments_batch(client: genai.Client, comments_list: list, course_level: str = "undergraduate"):
    """
...
def batch_refine_existing_results(client: genai.Client, results_dir: str, course_level: str = "undergraduate"):
    """
